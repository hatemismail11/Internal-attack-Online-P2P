...
As a consequence of experiencing high chunk loss rate, higher values of $\eta x, MN$ result in lower peer satisfaction over time, where benign peers at $(\eta x, MN)=(5, 15)$ restore their satisfaction level at approximately 340s, which is earlier than at $(\eta x, MN)=(7, 70)$ and $(\eta x, MN)=(8, 24)$.
...
As depicted in Figure~\ref{subfig:BRNL}, after the detection mechanism starts operating at $t=250s$, we observe an increase in the benign headnodes ratio in the source's neighbor list.
