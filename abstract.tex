...
Online streaming is a popular service for data-intensive applications where P2P-based streaming solutions are advocated to help reduce costs for both providers and users.
...
Accordingly, we propose a detection/mitigation mechanism that identifies the attack and removes potential malicious peers from their disruptive positions. 
